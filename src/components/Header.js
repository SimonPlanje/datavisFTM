...
function Header(){
    ...
    return(
        <div className="headerDiv">
            <img alt="afbeelding follow the money" className='headerImg' src="https://www.ftm.nl/uploads/cache/article_2800_nocrop/uploads/media/5fc527483804e/politicaladsdatabase-v1.jpg" />
